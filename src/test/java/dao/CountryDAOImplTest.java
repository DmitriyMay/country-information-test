...
public class CountryDAOImplTest extends TestCase {
    ...
    private static CountryServiceImpl service;
    ...
    public void testCreateCountry() {
        ...
        Optional<Country> countryOptional = dao.getCountryByName("AAA");
    ...
    public void testGetCountriesByDomain() {
        Optional<List<Country>> countries = dao.getCountriesByDomain("a");
    ...
    public void testGetCountryByName() {
        Optional<Country> countryOptional = dao.getCountryByName("albania");
